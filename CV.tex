...
\raggedbottom
\renewcommand\cvavatarradius{0}
\renewcommand\cvavatarborderwidth{0}
\renewcommand\cvheaderoffset{10}
\begin{cv}{Jason Reeves}{Systems \& Infrastructure Engineering Leader}
\cvsidebar %-----------------------------------------------------------------------------
...
\cvseparator
\begin{cvitem}
  \footnotesize \textbf{Ham Radio Technician (KC5TTQ)}
\end{cvitem}
...
\begin{cvevent}[October 2025][April 2026]
