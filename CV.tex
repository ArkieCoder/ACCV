...
\begin{cvevent}[2025]
    ...
    In order to teach myself some things about the Go programming language as well as AI tools, I vibe coded \tt{go-mem}, a console mode game to assist in memorizing texts.  The project may be viewed and downloaded at https://github.com/ArkieCoder/go-mem.
    \vspace*{5mm}
\end{cvevent}
