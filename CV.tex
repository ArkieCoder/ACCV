...
\begin{cvevent}[June 2024][present]
    ...
    Participated on the Site Reliability Engineering team maintaining AWS infrastructure for Typescript apps running in AWS Elastic Kubernetes Service accessing MongoDB and PostgreSQL databases and Redis cache servers.  We used Prometheus and Grafana as our monitoring solution, as well as Sentry for alerts.
    \vspace*{3mm}
