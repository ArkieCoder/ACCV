...
\raggedbottom
\begin{cv}[avatar]{Jason Reeves}{Systems \& Infrastructure Engineering Leader}
\cvsidebar %-----------------------------------------------------------------------------
...
\cvsection[skills]{Certs\textsuperscript{*} \& Skills}  %-----------------------------------------------------------
\begin{cvitem}
...
\cvseparator
\begin{cvitem}
  \footnotesize \textbf{FCC Amateur Radio Technician Class License -- KC5TTQ}
\end{cvitem}

\cvseparator
\begin{cvitem}
  \footnotesize Cloud providers: AWS, GCP
\end{cvitem}

\cvseparator
\begin{cvitem}
  \footnotesize OS \& orchestration: Linux, Kubernetes, Docker, containerization
\end{cvitem}

\cvseparator
\begin{cvitem}
  \footnotesize AI tools: OpenCode, Gemini, Copilot, Grok, ChatGPT, Claude
\end{cvitem}

\cvseparator
\begin{cvitem}
  \footnotesize Automation: Terraform, Terragrunt, Tofu, Ansible, Scripting
\end{cvitem}

\cvseparator
\begin{cvitem}
  \footnotesize Programming/scripting languages: Python, Ruby, Perl, Bash
\end{cvitem}

\cvseparator
\begin{cvitem}
  \footnotesize Soft skills: Root cause analysis, engineer mentoring, problem solving
\end{cvitem}

\begin{center}
  \footnotesize * \textit{Certifications and licenses are in} \textbf{bold} \textit{type}.
\end{center}
\vspace{-3mm}
...
\begin{itemize}
  ...
  \item Amateur Radio Club of the University of Arkansas --- President; Editor, \textit{Razorback Radio News}
\end{itemize}
\vspace*{3mm}
\begin{center}
...
I am a hands-on systems and infrastructure engineering leader with over 30 years of experience spanning Unix and Linux administration, software development, datacenter operations, cloud platforms, and DevOps. I work best as a player-coach: building and troubleshooting systems, setting practical technical standards, and mentoring engineers. I am also a Christian, a father, a musician, a tinkerer, and a reader who is always looking for new things to learn.
\vspace*{3mm}

In recent years, I have architected systems, developed software, implemented infrastructure as code, and built CI/CD pipelines across AWS and GCP. I have managed production Kubernetes clusters and used artificial intelligence tools to augment my engineering velocity.
\vspace*{3mm}

\textbf{U.S. Citizen · Active federal Public Trust determination · Able to obtain a security clearance · Available for on-site work in Fayetteville, Arkansas}

\cvsection[work]{Recent Work Experience}
%------------------------------------------------------
\begin{cvevent}[April 2026][present]
    \cvname{AI Engineer (GS-15)}
    \cvdescription{U.S. Department of the Treasury, Washington, DC - Remote}
    Served first as lead architect for Treasury's GitHub Enterprise Cloud migration, then moved to the CAELUM cloud platform team and became functional lead for Developer Platform Engineering.  Set technical direction, reviewed infrastructure changes, interviewed and mentored engineers, and built reusable governance, onboarding, automation, and AI-assisted code-review tools for a regulated environment.
    \vspace*{3mm}

    \textbf{Skills:}  GitHub Enterprise · GitHub Actions · Amazon Web Services (AWS) · Kubernetes · EKS · Terraform · Python · ServiceNow · DevSecOps · Platform Engineering · AI-assisted Engineering

    \vspace*{5mm}
\end{cvevent}

\begin{cvevent}[October 2024][April 2026]
    \cvname{Principal Architect}
    \cvdescription{Reeves Family Enterprises - Remote}
    Worked for Midwestern Interactive as an infrastructure consultant for their customer, YouVersion, the makers of the Bible app.  I was embedded within their SRE team, then transitioned to work on YV Platform, an API offering exposing YV data to third-party application developers.  I am working on infrastructure as code, observability, and security initiatives as part of a larger architectural push.
    \vspace*{3mm}

\textbf{Skills:}  OpenCode · Gemini · Google Cloud Platform (GCP) · GitLab · New Relic · Terraform · Python · Apigee  
    
    \vspace*{5mm}
\end{cvevent}
    
\begin{cvevent}[June 2024][December 2025]
    \cvname{Senior Site Reliability Engineer}
    \cvdescription{SPS Commerce, Rogers, AR - Hybrid}
    Participated on the Site Reliability Engineering team maintaining AWS infrastructure for TypeScript apps running in AWS Elastic Kubernetes Service accessing MongoDB and PostgreSQL databases and Redis cache servers.  We used Prometheus and Grafana as our monitoring solution, as well as Sentry for alerts.  I used Claude, Grok, ChatGPT, and GitHub Copilot to generate code and documentation.
    \vspace*{3mm}

\textbf{Skills:}  Linux · Terraform · jq · Shell Scripting · GitHub · Amazon Web Services (AWS) · Docker · Kubernetes · TypeScript · Prometheus · Grafana
    
    \vspace*{5mm}
\end{cvevent}

\begin{cvevent}[December 2023][June 2024]
    \cvname{Lead Solutions Engineer}
    \cvdescription{AFG.tech, Dallas, TX - Remote}
...
\begin{cvevent}[2026]
    \cvname{Treasury Caelum EKS}
    \cvdescription{U.S. Department of the Treasury, Washington, DC}
    Provided technical leadership for a cross-team effort to build out a shared application deployment platform on Amazon EKS.  The team built out private-cluster access, managed compute, GitOps reconciliation, networking, workload identity, rebuild, and operational workflows.
    \vspace*{5mm}
\end{cvevent}

\begin{cvevent}[2025]
    \cvname{The Charge to Timothy \& Titus}
    \cvdescription{Personal Project}
    I set the NASB 1977 text of I Timothy, II Timothy, and Titus to music in lead sheet format.  I leveraged AI tools to create software which generated score videos of the songs, and created a printed booklet of the songs with QR codes that link to the videos on YouTube.
    \vspace*{5mm}
\end{cvevent}
...
\begin{cvevent}[2025]
    \cvname{go-mem}
    \cvdescription{Personal Project}
    In order to teach myself some things about the Go programming language as well as AI tools, I built \texttt{go-mem}, a console mode game to assist in memorizing texts.  The project may be viewed and downloaded at https://github.com/ArkieCoder/go-mem.
    \vspace*{5mm}
\end{cvevent}

\begin{cvevent}[2025]
    \cvname{AWS/Kubernetes Cluster Compliance}
    \cvdescription{SPS Commerce, Rogers, AR}
    Implemented a comprehensive labeling scheme in our Kubernetes cluster to comply with SPS Commerce's post-acquisition requirements, along with a tagging regime required by SPS with regard to our AWS infrastructure.  Additionally, architected the solution to switch Kubernetes secrets from HashiCorp Vault secrets where Vault ran within our clusters, to using AWS Secrets Manager where the secrets existed in a different AWS account.  This required careful cross-account IAM design and coordination across teams.
    \vspace*{5mm}
\end{cvevent}

\begin{cvevent}[2025]
    \cvname{Move to One URL}
    \cvdescription{SPS Commerce, Rogers, AR}
    SupplyPike, a subsidiary of SPS Commerce, originally had multiple app URLs.  Using a combination of the Traefik reverse proxy server for Kubernetes and configuration of Amazon Application Load Balancers, I successfully switched SupplyPike from using multiple application domains to just one.  This required careful coordination over weeks with different teams, and planning how things were rolled out.
    \vspace*{5mm}
\end{cvevent}

\begin{cvevent}[2023-2024]
    \cvname{Data Warehouse Ingestion Pipeline}
    \cvdescription{AFG.tech, Dallas, TX}
...
\begin{cvevent}[Feb 2009][Jul 2011]
  ...
  United Entropy Associates was the name of the company I created as a convenience to facilitate working on various contracts. Wherever you see that I was working on a contract basis in my resume, I was actually working via the vehicle of United Entropy Associates. I've outlined in more detail the longer and more rewarding contracts in which I engaged, but during this period I was servicing smaller clients. These clients typically were small businesses with e-commerce websites backed by QuickBooks. We used a third-party provider to provide X-Cart (QuickBooks sync) functionality for these customers, while writing custom code in HTML, CSS, JavaScript, and PHP.
...
\begin{cvevent}[Sep 2005][Sep 2007]
  ...
  In this position I was also responsible for administering Cronacle, an enterprise job scheduling system tightly integrated with Oracle database software.
  \vspace*{3mm}
...
\begin{cvevent}[Sep 2001][Sep 2004]
  ...
  \cvdescription{Tyson Foods, Springdale, AR}
  I worked in Tyson's datacenter, operating huge high-speed printers, writing software, improving processes, and managing onsite and offsite backup media. I used the opportunity while I was working the weekend night shift to take advantage of Tyson's tuition reimbursement program. I went back to school and started finishing up my Computer Science and Mathematics degrees.
  \vspace*{3mm}
...
\begin{cvevent}[Mar 2000][May 2000]
  ...
  OnTheVerge was a web hosting provider. I was responsible for administering Apache and IIS websites for customers, datacenter runs, cabling, OS patches, and upgrades.
  \vspace*{3mm}
...
\begin{cvevent}[Nov 1999][Mar 2000]
  ...
  I worked a few short months at UC San Diego. The crew there was too good to me, but I was young and restless, and found a job that would pay me slightly more. I worked in an academic computing setting installing various Unix-based software packages and supporting those software packages over the phone and through creating documentation.
  \vspace*{3mm}
  
  \textbf{Skills:} Perl · Linux · Shell Scripting · IRIX · Solaris
  \vspace*{5mm}
\end{cvevent}
...
\begin{cvevent}[Jan 1997][Nov 1998]
  ...
  Wrote Java servlets, implemented database connection pooling, and worked with virtual database drivers that performed screen scraping from a TN5250 terminal interface.
  \vspace*{3mm}
