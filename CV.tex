...
\cvseparator
\begin{cvitem}
  \footnotesize Automation: Terraform, Terragrunt, Tofu, Ansible, Scriptuing
\end{cvitem}
...
\begin{cvevent}[2025]
    ...
    I set the NASB 1977 text of I Timothy, II Timothy, and Titus to music in lead sheet format.  I leveraged AI tools to create software which generated score videos of the songs, and created a printed booklet of the songs with QR codes which link to the videos in YouTube. 
    \vspace*{5mm}
\end{cvevent}
